# Clinical Co-Pilot — Week 2 System Architecture Specification

> **Audience:** a build agent implementing Week 2 with no other context. Concrete and
> unambiguous over impressive. This file is the seed of the required `./W2_ARCHITECTURE.md`.
>
